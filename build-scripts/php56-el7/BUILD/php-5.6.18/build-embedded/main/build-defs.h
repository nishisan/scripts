...
#define PHP_IFX_LIBS		""
#define PHP_INSTALL_IT		"$(mkinstalldirs) $(INSTALL_ROOT)$(libdir); $(LIBTOOL) --mode=install $(INSTALL) -m 0755 $(OVERALL_TARGET) $(INSTALL_ROOT)$(libdir)"
